...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            elif event.key == pygame.K_DOWN and mainPlayer.direction != "UP":
                mainPlayer.direction = "DOWN"
            elif event.key == pygame.K_LEFT and mainPlayer.direction != "RIGHT":
                mainPlayer.direction = "LEFT"
            elif event.key == pygame.K_RIGHT and mainPlayer.direction != "LEFT":
